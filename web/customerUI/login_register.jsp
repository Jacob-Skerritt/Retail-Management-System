<%-- 
    ...
    Created on : 20-Nov-2018, 18:31:11
    Author     : User
--%>
...
<div class="container" >
	<div class="d-flex justify-content-center h-100" >
		<div class="card" >
			...
			<div class="card-body">
                            <form action="loggedIn_index.jsp" style="background-color: grey">
                                <p style="text-align: center;"><strong>TO RESERVERVE YOU MUST LOGIN</strong></p>
