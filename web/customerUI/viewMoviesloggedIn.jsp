<%-- 
    Document   : viewMoviesloggedIn
    Created on : 20-Nov-2018, 19:25:14
    Author     : User
--%>
...
<%@include file="includes/nav_bar2.jsp" %>
        ...
        <div>
                ...
                <div style="background-color: grey; text-align: center; margin-top: 8%"><h3>ACTION</h3></div>
                <!-- Page Features -->
                <div class="row text-center">

                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <img class="card-img-top" src="images/venom.jpg" alt="">
                            <button class="btn" onclick="location.href='details.jsp'">Details</button>
                            
                            
                            <button class="newbtn" onclick="location.href='reserve.jsp'">Reserve</button>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
